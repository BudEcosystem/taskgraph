...
impl Display for EventType {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        f.write_str(match self {
            ...
            Self::TaskSleeping => "task_sleeping",
            Self::TaskWakeDue => "task_wake_due",
            Self::TaskResumed => "task_resumed",
            Self::ProcessStarted => "process_started",
            Self::ProcessHookMatched => "process_hook_matched",
...
impl FromStr for EventType {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "task_sleeping" => Ok(Self::TaskSleeping),
            "task_wake_due" => Ok(Self::TaskWakeDue),
            "task_resumed" => Ok(Self::TaskResumed),
            "process_started" => Ok(Self::ProcessStarted),
            "process_hook_matched" => Ok(Self::ProcessHookMatched),
            "process_exited" => Ok(Self::ProcessExited),
            "process_killed" => Ok(Self::ProcessKilled),
            "process_stuck" => Ok(Self::ProcessStuck),
